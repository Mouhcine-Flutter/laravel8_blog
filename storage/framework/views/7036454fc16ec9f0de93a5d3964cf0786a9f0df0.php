...
<?php $component->withAttributes([]); ?>
        <form method="POST" action="/posts/<?php echo e($post->slug); ?>/comments">
            ...
            <header class="flex items-center">
                <img src="https://i.pravatar.cc/60?u=<?php echo e(auth()->id()); ?>"
                     alt=""
                     width="40"
                     height="40"
                     class="rounded-full">
...
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>Submit <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php endif; ?>
<?php /**PATH /Users/dev/Laravel/blog/resources/views/posts/_add-comment-form.blade.php ENDPATH**/ ?>